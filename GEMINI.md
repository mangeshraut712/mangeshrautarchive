...
9. **First-Class Automated Testing:** Maintain 100% passing tests (261 Vitest, 175 pytest, 16-browser Playwright matrix).
...
```bash
# 1. Full Check Gate (ESLint + Stylelint + Prettier + 261 Vitest Tests)
