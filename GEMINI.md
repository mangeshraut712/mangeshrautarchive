...
9. **First-Class Automated Testing:** Maintain 100% passing tests (303 Vitest, 179 pytest, 16-browser Playwright matrix).
...
```bash
# 1. Full Check Gate (ESLint + Stylelint + Prettier + 303 Vitest Tests)
...
# 3. Python API Test Suite (179 pytest tests)
