...
9. **First-Class Automated Testing:** Maintain 100% passing tests (255 Vitest, 175 pytest, 16-browser Playwright matrix).
...
```bash
# 1. Full Check Gate (ESLint + Stylelint + Prettier + 255 Vitest Tests)
