...
- **Support Integration** — Integrated direct checkout and donation channels via Stripe, PayPal, and Buy Me a Coffee, alongside direct crypto wallets (SOL, BTC, USDC, ETH, DOGE, SHIB) with one-click copy.
