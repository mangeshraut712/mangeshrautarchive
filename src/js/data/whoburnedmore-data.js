...
export const whoburnedmoreProfile = {
  ...
  tools: [
    ...
    },
    {
      ...
      role: 'AI-Native IDE',
      context:
        'Primary AI-native IDE environment, full-repo context orchestration, and smart copilot edits',
    },
    {
      name: 'KiloChat & Code',
      shortName: 'Kilo',
      icon: 'assets/images/vibe-tools/kilo.png',
      tokens: '611.0M',
      tokensRaw: 610_967_596,
      share: '4.5%',
      spend: '$0',
      role: 'Multi-Model Chat',
      context: 'Pair programming, multi-model evaluation, and interactive terminal chat interface',
    },
    {
      name: 'Cline',
      shortName: 'Cline',
      icon: 'assets/images/vibe-tools/cline.png',
      tokens: '61.4M',
    ...
    },
    {
      ...
      icon: 'assets/images/vibe-tools/antigravity.png',
      tokens: null,
      tokensRaw: 0,
      share: 'Active',
      spend: 'Live',
      ...
      context:
        'Autonomous multi-agent pair programming, in-situ visual audits & architectural refactoring',
    },
  ],
  ...
  // Cache economics breakdown items
  cacheTelemetry: [
    {
      id: 'cache-reads',
