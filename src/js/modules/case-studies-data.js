...
export const flagshipOssProjects = [
  ...
  },
  {
    slug: 'hindai',
    title: 'HindAI',
    summary: 'Indic learning + grounded scripture assistant (TypeScript)',
    status: 'Active',
    href: 'https://github.com/mangeshraut712/Hindai',
  },
  {
    slug: 'gravity',
    title: 'Gravity SaaS Agent',
    summary: 'Multi-tenant AI agents with MCP, WhatsApp, and billing',
    status: 'Active',
    href: 'https://github.com/mangeshraut712/Gravity-SaaS-Agent',
  },
  {
    slug: 'ai-ml-portfolio',
    title: 'ai-ml-portfolio',
    summary: 'Speech VAD, RAG evaluation, and NumPy ML from scratch',
    status: 'Active',
    href: 'https://github.com/mangeshraut712/ai-ml-portfolio',
  },
  {
    slug: 'agent-console',
    title: 'agent-console',
    summary: 'Real-time agent console with tools and observability',
    status: 'Active',
...
export const caseStudies = [
  ...
  },
  {
    slug: 'assistme-va',
    repoName: null,
    title: 'AssistMe (portfolio assistant)',
    tagline: 'Voice + chat assistant shipping inside the live portfolio stack.',
    demoUrl: 'https://mangeshraut712.github.io/mangeshrautarchive/',
    repoUrl: 'https://github.com/mangeshraut712/mangeshrautarchive',
    blogId: null,
    ...
    metrics: [
      ...
      { label: 'Backend', value: 'FastAPI + Worker' },
      { label: 'Frontend', value: 'Vanilla ESM' },
      { label: 'Hosts', value: 'Pages + Edge' },
    ],
    problem:
    ...
    approach:
      'AssistMe now ships inside mangeshrautarchive: OpenRouter-backed chat, Voice Mode, WebMCP tools, and Cloudflare Worker fallbacks for GitHub Pages.',
    tradeoffs:
      'Voice adds latency and browser permission friction; tool breadth is capped to keep reliability high on consumer hardware.',
    results: [
      'Live AssistMe on GitHub Pages with edge API fallback',
      'Voice Mode and research/tool pathways in one product surface',
      'Same assistant patterns reused across portfolio monitor and chatbot UX',
    ],
    improvements: [
      'Eval harness for AssistMe tool-calling accuracy',
      'Unified model router policy across chat and voice lanes',
      'Automated eval suite for tool-call success rate',
    ],
    stack: ['Vanilla JS', 'FastAPI', 'OpenRouter', 'Cloudflare Workers', 'WebMCP'],
    architectureAnchor: 'systems.html#architecture-assistme',
  },
  {
    slug: 'bug-tracker',
    ...
    tagline: 'Full-stack product engineering — historical portfolio case study.',
    demoUrl: null,
    repoUrl: null,
    blogId: null,
    ...
    approach:
      'Django REST Framework API with PostgreSQL, React UI, and Dockerized services. The public GitHub repo for this demo was retired; the engineering story remains as a case study.',
    tradeoffs:
      'Chose proven Django admin patterns over microservices — faster delivery, simpler ops for portfolio scale.',
    results: [
      'Shipped create/update/status workflows with Dockerized local dev',
      'Clear separation between API models and React presentation layer',
      'Patterns informed later full-stack client and SaaS work',
    ],
    improvements: [
