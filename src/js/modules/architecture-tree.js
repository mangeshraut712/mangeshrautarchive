    ...
    this.nodes = [
      {
        ...
        badge: 'Vanilla ESM',
        desc: 'Pure Vanilla HTML5, CSS custom properties, and native ES modules (zero UI frameworks). Apple HIG Liquid Glass, 100/100 Lighthouse CI gate, and WebMCP agent hooks.',
        metrics: {
          runtime: '0 KB Framework',
          lighthouse: '100/100 CI',
      ...
      },
      {
        ...
        desc: 'Dual-host architecture: GitHub Pages static delivery with Cloudflare Workers edge proxy (assistme-chat…workers.dev) for real-time chat, music, and health probes.',
        metrics: {
          cdn: 'GitHub Pages (Fastly)',
          edgeWorker: 'Cloudflare Edge',
          status: 'Operational',
        },
        icon: 'fa-bolt',
        x: 380,
      ...
      },
      {
        id: 'models',
        title: 'LLM Gateway',
        badge: 'OpenRouter Proxy',
        desc: 'OpenRouter dynamic streaming proxy routing between Grok 4.3, Gemini 2.5 Flash, Claude 3.7, GPT-4o, and local deterministic fallback.',
        metrics: { primary: 'x-ai/grok-4.3', streamFormat: 'SSE NDJSON', fallback: 'Local Intel' },
        icon: 'fa-brain',
        x: 900,
        y: 110,
        links: [],
      },
      {
        ...
        badge: '17 Agentic Tools',
        desc: 'Browser-native agent execution suite enabling instant DOM navigation, project filtering, Spotify scrobbles, calendar reminders, and system diagnostics.',
        metrics: {
          tools: '17 Active Tools',
          protocol: 'WebMCP v1',
          latency: 'Local Instant (< 2ms)',
        },
        icon: 'fa-cube',
        x: 900,
        y: 290,
