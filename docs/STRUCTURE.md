...
│   ├── unit/                 # 303 Vitest unit tests across 56 files (JS modules, WebMCP actions)
│   ├── api/                  # 179 pytest API tests across 27 files (FastAPI routes, streaming, OAuth, middleware)
