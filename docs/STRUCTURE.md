...
│   ├── unit/                 # 287 Vitest unit tests across 54 files (JS modules, WebMCP actions)
│   ├── api/                  # 177 pytest API tests across 27 files (FastAPI routes, streaming, OAuth, middleware)
