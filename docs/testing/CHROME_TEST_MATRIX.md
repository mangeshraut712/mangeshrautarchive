...
| F-04 | P0       | User submits contact/chat flow     | Complete and submit contact/chat form.                    | Submission works; validation/sanitization enforced; clear success/failure messaging.      | Manual (automation pending)                                |
| F-05 | P0       | User opens links/downloads resume  | Activate resume download and key external links.          | Correct asset opens/downloads; no 404 or mixed-content errors.                            | Manual (automation pending)                                |
